...
public class MainController {
	...
	public String home(Model model) {
		...
		model.addAttribute("listaPropietarios", daoPropietario.findAll());
	...
	public String altapropietario(Model model, @ModelAttribute Propietario prop, @RequestParam String dni, @RequestParam String nombre, 
